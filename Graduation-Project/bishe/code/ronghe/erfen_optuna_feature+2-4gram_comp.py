...
def run_tuning_experiment():
    ...
    # 2. 预提取融合特征 (核心修改点：ngram_range=(2, 4))
    print("\n提取 2-4 gram 与统计特征并融合...")
    # 注意：2-4 gram 特征空间极大，建议使用 min_df=5 过滤低频噪点
    ...
    # 4. 执行调参
    print(f"\n--- 开始二分类融合组 (2-4 gram) 贝叶斯调参 (Trials=20) ---")
    ...
    # 6. 统一输出
    print("\n" + "=" * 50)
    print(f"{'实验结果: 二分类特征融合 (统计+2-4gram) 贝叶斯版':^50}")
    print("=" * 50)
